...
<form class="frm-transaction-details">
				...
				<div class="span7">
					<div class="row" style="margin-bottom:-15px;">
						...
						<div class="span7" style="margin-top:-30px;">
							...
							`	</div>
								<div class="span3">
									<input type="number" min=0 onchange="if(this.value < 0){this.value = 0;}"  class="txt-discount span2" style="float:left;margin-right:10px;margin-top:16px;" autofocus=autofocus /><h4 style="float:left;">%</h4>
								</div>
							</div>		
						</div>
					</div>
	...
	<div class="row" <?php if($view == "createTransactions")echo "hidden";?>>
		<div class="span7">
			<div class="row">
				<div class="span7">
							...
							<div class="row" >
								...
								<div class="row">	
									<div class="span3">
										...
										<input type="number" min=0 onchange="if(this.value < 0){this.value = 0;}" class="span2 txt-cash-received required" style="float:left;margin-top:16px;"/>
								`	</div>
								</div>		
							</div>
						</div>
	...
	<div>
		...
		<button type="submit" class="btn btn-primary btn-submit-transaction-details" style="float:right;" type="button">Save Transaction</button>
	<div>
</form>
