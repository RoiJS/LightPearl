...
<form class="frm-print-transaction-details" id="<?php echo $transaction['row']['transaction_id'];?>">
				...
				<div class="span7">
					<div class="row" style="margin-bottom:-15px;">
						...
						<div class="span7" style="margin-top:-30px;">
							...
							`	</div>
								<div class="span3">
									<h4 style="float:left;"><?php echo $transaction['row']['discount'] != '' ?  $transaction['row']['discount'] : '0' ;?> %</h4>
								</div>
							</div>		
						</div>
					</div>
	...
	<div>
		<button class="btn btn-warning close-trasaction-details-form" style="float:left;" type="button">Cancel Print</button>
		<button id="<?php echo $transaction['row']['id']?>" class="btn btn-primary btn-print-transaction" outputtype="invoice" style="float:right;margin-right:10px;" type="button">Print as Invoice</button>
		<button id="<?php echo $transaction['row']['id']?>" class="btn btn-success btn-print-transaction" outputtype="delivery report" style="float:right;margin-right:10px;" type="button">Print as Delivery Report</button>
	</div>
</form>
